...
const Alert = (title, type) => {
  ...
  switch (type) {
    case 'fav': {
      color = '#ff6b6b'
      icon = '<img src="../assets/imgs/favorito.png">'
      customClass = {
        icon: 'sweet-icon-fav',
    ...
    case 'delete': {
      color = '#e03131'
      icon = '<img src="../assets/imgs/delete-account.png">'
      customClass = {
        icon: 'sweet-icon-cart',
        image: 'sweet-icon-cart',
        title: 'sweet-text-cart',
    ...
    case 'updateBook': {
      color = '#22b8cf'
      icon = '<img src="../assets/imgs/books.png">'
      customClass = {
        icon: 'sweet-icon-cart',
        image: 'sweet-icon-cart',
        title: 'sweet-text-cart',
    ...
    case 'updateCarrousel': {
      color = '#22b8cf'
      icon = '<img src="../assets/imgs/image-files.png">'
      customClass = {
        icon: 'sweet-icon-cart',
        image: 'sweet-icon-cart',
        title: 'sweet-text-cart',
    ...
    case 'updateOrder': {
      color = '#22b8cf'
      icon = '<img src="../assets/imgs/order.png">'
      customClass = {
        icon: 'sweet-icon-cart',
        image: 'sweet-icon-cart',
        title: 'sweet-text-cart',
    ...
    case 'email': {
      color = '#22b8cf'
      icon = '<img src="../assets/imgs/email.png">'
      customClass = {
        icon: 'sweet-icon-cart',
        image: 'sweet-icon-cart',
        title: 'sweet-text-cart',
