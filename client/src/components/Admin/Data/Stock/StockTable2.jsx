...
import styles from '../../../../Styles/StockTable2.module.css'
  ...
  return books.length ? (
    <div className={styles.containerStock}>
      ...
      <div className={styles.containerButtonNavigation}>
        ...
        <Link to='/stocktable'>
          <button className={styledButton.btnAdmin}>DataGrid</button>
        </Link>

        <Link to='/stock'>
          <button className={styledButton.btnAdmin}>Formato Cartas</button>
        </Link>
      </div>
      ...
      <div className={styles.containerPrimaryActions}>
