      ...
      <form className={styles.userForm} onSubmit={(e) => handleSubmit(e)}>
        ...
        <div className={styles.containerInputsGrid}>
          ...
          <div className={styles.containerInput}>
            ...
            />
            {errors.birthday ? (
              <p className={styles.error}>{errors.birthday}</p>
            ) : null}
          </div>
          ...
          <div className={styles.containerInput}>
            ...
            <input
              ...
              value={input.dni}
            />
            {errors.dni && input.dni ? (
              <p className={styles.error}>{errors.dni}</p>
            ) : null}
          </div>
          ...
          <div className={styles.containerInput}>
            ...
            />
            {errors?.ciudad ? (
              <p className={styles.error}>{errors.ciudad}</p>
            ) : null}
          </div>
          ...
          <div className={styles.containerInput}>
            ...
            />
            {errors?.postal ? (
              <p className={styles.error}>{errors.postal}</p>
            ) : null}
          </div>
